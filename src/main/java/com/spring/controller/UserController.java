...
////show image in html table
	...
	public String deleteProduct(@PathVariable int id, HttpSession session) {
	 ...
	 @GetMapping("/editpost/{id}")
		...
		public String UpdateResume( @ModelAttribute PostClass postClass, HttpSession session) {
			
			postservice.saveUser(postClass);
			session.setAttribute("msg", "user' details updated successsfully !");
			
			return "redirect:/user/editpost";
		}
